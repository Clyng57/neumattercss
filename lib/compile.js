...
fs.writeFile( `${exportPath}neumatter.css`, neumatter, err => {
  if (err) throw err;
  console.log(
    chroma.magenta.bold.paint('neumatter.css______________________________________\n'),
    chroma.green.paint('successful\n'),
    chroma.cyan.paint('folder:'),
    `${exportPath}\n`,
    chroma.cyan.paint('date:'), 
